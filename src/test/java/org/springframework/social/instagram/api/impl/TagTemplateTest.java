...
public class TagTemplateTest extends AbstractInstagramApiTest {
	...
	@Test
	public void getTag() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/tags/cats/?access_token=ACCESS_TOKEN")).andExpect(method(GET))
	...
	public void searchTags() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/tags/search/?access_token=ACCESS_TOKEN&q=cats")).andExpect(method(GET))
	...
	public void recentMedia() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/tags/cats/media/recent/?access_token=ACCESS_TOKEN")).andExpect(method(GET))
	...
	public void recentMediaParams() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/tags/cats/media/recent/?access_token=ACCESS_TOKEN&min_id=200&max_id=100"))
