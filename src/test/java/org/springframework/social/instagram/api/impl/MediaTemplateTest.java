...
public class MediaTemplateTest extends AbstractInstagramApiTest {
	...
	public void getMedia() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/media/48904105/?access_token=ACCESS_TOKEN")).andExpect(method(GET))
	...
	public void getPopular() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/media/popular/?access_token=ACCESS_TOKEN")).andExpect(method(GET))
	...
	@Test
	public void search() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/media/search/?access_token=ACCESS_TOKEN&lng=200.0&lat=100.0")).andExpect(method(GET))
				.andRespond(withSuccess().body(new ClassPathResource("/testdata/media-list.json", getClass())).headers(responseHeaders));
	...
	public void searchMoreParams() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/media/search/?access_token=ACCESS_TOKEN&lng=200.0&distance=1000&lat=100.0"))
				.andExpect(method(GET)).andRespond(withSuccess().body(new ClassPathResource("/testdata/media-list.json", getClass())).headers(responseHeaders));
	...
	public void searchEvenMoreParams() {
		mockServer
				.expect(requestTo(
						"https://api.instagram.com/v1/media/search/?access_token=ACCESS_TOKEN&lng=200.0&distance=1000&max_timestamp=1000&min_timestamp=2000&lat=100.0"))
				.andExpect(method(GET)).andRespond(withSuccess().body(new ClassPathResource("/testdata/media-list.json", getClass())).headers(responseHeaders));
	...
	public void getLikes() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/media/12345/likes/?access_token=ACCESS_TOKEN")).andExpect(method(GET))
	...
	public void getComments() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/media/12345/comments/?access_token=ACCESS_TOKEN")).andExpect(method(GET))
	...
	public void addComment() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/media/12345/comments/?access_token=ACCESS_TOKEN")).andExpect(method(POST))
	...
	@Test
	public void addLike() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/media/12345/likes/?access_token=ACCESS_TOKEN")).andExpect(method(POST))
				.andRespond(withSuccess().body(new ClassPathResource("/testdata/ok-response.json", getClass())).headers(responseHeaders));
	...
	public void deleteComment() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/media/12345/comments/54321/?access_token=ACCESS_TOKEN")).andExpect(method(DELETE))
				.andRespond(withSuccess().body(new ClassPathResource("/testdata/ok-response.json", getClass())).headers(responseHeaders));
	...
	public void deleteLike() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/media/12345/likes/?access_token=ACCESS_TOKEN")).andExpect(method(DELETE))
				.andRespond(withSuccess().body(new ClassPathResource("/testdata/ok-response.json", getClass())).headers(responseHeaders));
