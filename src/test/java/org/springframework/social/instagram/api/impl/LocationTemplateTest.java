...
public class LocationTemplateTest extends AbstractInstagramApiTest {
	...
	public void getLocation() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/locations/12345/?access_token=ACCESS_TOKEN")).andExpect(method(GET))
	...
	public void getRecentMedia() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/locations/12345/media/recent/?access_token=ACCESS_TOKEN")).andExpect(method(GET))
	...
	public void getRecentMediaParams() {
		mockServer
				.expect(requestTo(
						"https://api.instagram.com/v1/locations/12345/media/recent/?access_token=ACCESS_TOKEN&min_id=100&max_id=200&min_timestamp=5000&max_timestamp=10000"))
	...
	@Test
	public void search() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/locations/search/?access_token=ACCESS_TOKEN&lng=200.0&lat=100.0")).andExpect(method(GET))
	...
	public void searchWithDistance() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/locations/search/?access_token=ACCESS_TOKEN&lng=200.0&distance=2000&lat=100.0"))
				.andExpect(method(GET))
				.andRespond(withSuccess().body(new ClassPathResource("/testdata/location-search.json", getClass())).headers(responseHeaders));
	...
	public void searcgWithFourSquare() {
		mockServer.expect(requestTo("https://api.instagram.com/v1/locations/search/?access_token=ACCESS_TOKEN&foursquare_id=1000")).andExpect(method(GET))
				.andRespond(withSuccess().body(new ClassPathResource("/testdata/location-search.json", getClass())).headers(responseHeaders));
